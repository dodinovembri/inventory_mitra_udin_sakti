    ...
    <div class="content-body">
        <div class="component no-code">
            <div class="card rounded-5">
				<div class="card-body">       
                <div class="component">
                    <form method="POST" action="{{ url('update_data', $product->id) }}">
                        @csrf
                        <div class="row row-sm">
                            ...
                            <div class="col-sm-10">
                                <input type="text" style="margin-bottom:15px;" class="form-control" name="product_code" value="{{ $product->product_code }}" placeholder="Masukkan kode produk" readonly="">
                            </div>
                            <div class="col-sm-2">
                                <b><label class="form-label">Nama Produk</label></b>
                            </div>
                            <div class="col-sm-10">
                                <input type="text" style="margin-bottom:15px;" class="form-control" name="product_name" value="{{ $product->product_name }}" placeholder="Masukkan nama produk" required="">
                            </div>
                            <div class="col-sm-2">
